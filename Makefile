...
all: rds rds-sync ## Build all binaries

rds:
	@echo "[37m[1/2][0m [36;1mBuilding rds…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" rds.go

rds-sync:
	@echo "[37m[2/2][0m [36;1mBuilding rds-sync…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" rds-sync.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp rds /usr/bin/rds
	@cp rds-sync /usr/bin/rds-sync

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/rds
	@rm -f /usr/bin/rds-sync
