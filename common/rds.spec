...
%changelog
* Tue Nov 07 2023 Anton Novojilov <andy@essentialkaos.com> - 1.5.2-0
- [cli] Improved 'replication' command output
- [sync] Added "bye" command to unregister minion and sentinel nodes
- [sync] Added lag info to client info
