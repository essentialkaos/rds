...
func readBasicInstanceInfo() (*instanceBasicInfo, error) {
	...
	if options.GetB(OPT_SECURE) {
		for {
			info.ServicePassword, err = terminal.ReadPassword("Please enter the password for for service user (or leave blank for autogenerated password)", false)
...
func showInstanceInfo(meta *CORE.InstanceMeta, tags []string) {
